...
where ID_pracy = @input">
  ...
  <br /><br />
    ...
    <asp:DetailsView ID="DetailsView1" runat="server" Height="50px" Width="706px" AutoGenerateRows="False" DataSourceID="DSDanePodstawowe" CellPadding="4" ForeColor="#333333" GridLines="None">
...
order by Slowo_kluczowe.Nazwa asc">
    ...
    <div>
        <asp:GridView ID="GridView5" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="DSSlowaKluczowe" ForeColor="#333333" GridLines="None">
            <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
            <Columns>
...
where Recenzenci.ID_pracy = @input">
    ...
    <asp:SqlDataSource ID="DSKomisja" runat="server" ConnectionString="<%$ ConnectionStrings:PraceDyplomoweCS %>" SelectCommand="SELECT [Czlonek_komisji] FROM [viewKomisja] WHERE ([ID_pracy] = @ID_pracy)" OnSelecting="DSKomisja_Selecting">
        <SelectParameters>
            <asp:QueryStringParameter Name="ID_pracy" QueryStringField="ID_pracy" Type="Int32" />
        </SelectParameters>
            </asp:SqlDataSource>
    <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="DSKomisja" ForeColor="#333333" GridLines="None">
        <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
        <Columns>
            <asp:BoundField DataField="Czlonek_komisji" HeaderText="Członek komisji" SortExpression="Czlonek_komisji"/>
        </Columns>
        <EditRowStyle BackColor="#999999" />
        <FooterStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
        <HeaderStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
